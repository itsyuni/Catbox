    ...
    <div class="container padding">
        <div class="row padding">
            <div class="col-md-4">
                ...
                <div class="card">
                    <img class="card" src="/static/images/apps/calc.png" alt="2048">
                    <div class="card-body">
                        <center><h4 class="card-title">Калькулятор</h4></center>
                        <hr>  
                        <p class="card-text">Быстро решайте математические задания прямо в браузере.</p>   
                        <center><a href="init?name=calc" class="btn btn-serverst">Перейти</a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            <div class="card">
                    <img class="card" src="/static/images/apps/paint.png" alt="2048">
                    <div class="card-body">
                        <center><h4 class="card-title">Paint</h4></center>
                        <hr>  
                        <p class="card-text">Рисуйте свои шедевры везде где угодно.</p>   
                        <center><a href="init?name=paint" class="btn btn-serverst">Перейти</a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            <div class="card">
                    <img class="card" src="/static/images/apps/weather.png" alt="2048">
                    <div class="card-body">
                        <center><h4 class="card-title">Прогноз погоды</h4></center>
                        <hr>  
                        <p class="card-text">Узнавайте точный прогноз погоды прямо в браузере.</p>   
                        <center><a href="init?name=weather" class="btn btn-serverst">Перейти</a></center>
                    </div>
                </div>
            </div>
        </div>
