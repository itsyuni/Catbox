    ...
    if (e.keyCode == 9) { // tab
      ...
      switch (cmd) {
        ...
        case 'file':
          ...
          break;
        case 'msbin':
          output('<h2>MS Bin</h2><p>'+'</p><p>Version 0.2 BETA</p>'+'<p>Автор: Nikita Astahov</p>'+'<p>Build:1000</p>'+'<p>CatboxGroup</p>'+'<p>Версия создана 14.08.2020</p>'+'<p>End supprort: ¯\_(ツ)_/¯</p>');
          break;
        case 'open':
